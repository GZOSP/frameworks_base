...
public class AdbOverNetworkTile extends QSTileImpl<BooleanState> {
        ...
        if (!isAdbEnabled()) {
           Toast.makeText(mContext, mContext.getString(
            ...
            Settings.Global.putInt(mContext.getContentResolver(),
                    Settings.Global.GZOSP_ADB_PORT, isAdbNetworkEnabled() ? 0 : 5555);
        }
        refreshState();
    }
    ...
    public int getMetricsCategory() {
        return MetricsEvent.GZOSP_METRICS;
    }
    ...
    private boolean isAdbNetworkEnabled() {
        return Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.GZOSP_ADB_PORT, 0) > 0;
    }
        ...
        if (mListening != listening) {
            ...
            if (listening) {
                mContext.getContentResolver().registerContentObserver(
                        Settings.Global.getUriFor(Settings.Global.GZOSP_ADB_PORT),
                        false, mObserver);
                mContext.getContentResolver().registerContentObserver(
