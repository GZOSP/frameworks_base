...
import com.android.internal.util.gzosp.GzospLockPatternUtils;
...
public class KeyguardBouncer {
    ...
    private final GzospLockPatternUtils mGzospLockPatternUtils;
    ...
    public KeyguardBouncer(Context context, ViewMediatorCallback callback,
        ...
        mGzospLockPatternUtils = new GzospLockPatternUtils(mContext);
    }
        ...
        if (mKeyguardView != null) {
            ...
            if (mode == SecurityMode.SimPin || mode == SecurityMode.SimPuk) {
                return UNLOCK_SEQUENCE_FORCE_BOUNCER;
                    ...
                    && mGzospLockPatternUtils.shouldPassToSecurityView(
