...
class GlobalActionsDialog implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener {
    ...
    private ActionsDialog createDialog() {
        ...
        if (!mHasVibrator) {
            ...
            mSilentModeAction = new SilentModeTriStateAction(getThemedContext(mContext), mAudioManager, mHandler);
        }
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View view = action.create(getThemedContext(mContext), convertView, parent, LayoutInflater.from(getThemedContext(mContext)));
            if (position == 2) {
