...
struct ResTable_config
{
  ...
  enum {
    ...
    enum {
        ...
        UI_MODE_NIGHT_TESLA = ACONFIGURATION_UI_MODE_NIGHT_TESLA << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_TIPSY = ACONFIGURATION_UI_MODE_NIGHT_TIPSY << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_VALIDUS = ACONFIGURATION_UI_MODE_NIGHT_VALIDUS << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_RETRO = ACONFIGURATION_UI_MODE_NIGHT_RETRO << SHIFT_UI_MODE_NIGHT,
