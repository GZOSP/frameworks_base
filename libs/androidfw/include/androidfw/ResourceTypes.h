...
struct ResTable_config
{
  ...
  enum {
    ...
    enum {
        ...
        UI_MODE_NIGHT_WHITE = ACONFIGURATION_UI_MODE_NIGHT_WHITE << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_BRED = ACONFIGURATION_UI_MODE_NIGHT_BRED << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_MINT = ACONFIGURATION_UI_MODE_NIGHT_MINT << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YELLOW = ACONFIGURATION_UI_MODE_NIGHT_YELLOW << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_PISSEL = ACONFIGURATION_UI_MODE_NIGHT_PISSEL << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_BLUE = ACONFIGURATION_UI_MODE_NIGHT_BLUE << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_PINK = ACONFIGURATION_UI_MODE_NIGHT_PINK << SHIFT_UI_MODE_NIGHT,
    };
